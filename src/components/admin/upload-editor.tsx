    ...
    <div className="space-y-2">
      ...
      <Dialog.Root open={isOpen} onOpenChange={closeDialog}>
        <Dialog.Portal>
          ...
          <Dialog.Content className="fixed left-1/2 top-1/2 z-[91] w-full max-w-2xl -translate-x-1/2 -translate-y-1/2 rounded-lg border border-border bg-background p-6 shadow-lg">
